...
WaypointTool::WaypointTool()
{
  ...
  topic_property_ = new StringProperty("Topic", "final_goal", "The topic on which to publish final navigation goals.",
...
void WaypointTool::updateTopic()
{
  ...
  pub_ = nh_.advertise<geometry_msgs::PointStamped>("/final_goal_point", 5);
