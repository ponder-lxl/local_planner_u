...
int main(int argc, char** argv)
{
  ...
  while (status)
  {
    ...
    // Keep odom/TF timestamps strictly increasing. With use_sim_time, /clock may
    // stay unchanged across several 200Hz loop iterations, which triggers
    // TF_REPEATED_DATA if the same stamp is published again.
